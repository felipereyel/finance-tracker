...
func AssetsURLWithQuery(walletFilter string, tagFilter string) string {
	return fmt.Sprintf("%s?%s=%s&%s=%s", AssetsURL, WalletQueryParam, walletFilter, TagQueryParam, tagFilter)
}
